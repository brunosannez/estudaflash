...
const DailyMission = () => {
  ...
  if (loading) {
    return (
      <Card className="bg-gradient-to-br from-violet-50 to-sky-50 border-violet-200/50 animate-pulse">
        <CardContent className="p-6">
          <div className="h-6 bg-violet-200 rounded w-1/3 mb-4"></div>
          <div className="h-16 bg-violet-100 rounded"></div>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card className="bg-gradient-to-br from-violet-50 via-sky-50 to-emerald-50 border-violet-200/50 shadow-lg overflow-hidden">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className={`font-semibold ${isCompleted ? 'text-emerald-700' : 'text-gray-800'}`}>
                          {mission.title}
                        </h4>
                        {isCompleted && (
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className={`font-medium ${isCompleted ? 'text-emerald-600' : 'text-violet-600'}`}>
                            +{mission.xpReward} XP
                          </span>
                        </div>
                        <Progress 
                    ...
                    {!isCompleted && (
                      <Button
                        ...
                        className="flex-shrink-0 bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 text-white shadow-md"
                      >
                        Ir
