...
const DailyMission = () => {
  ...
  if (loading) {
    return (
      <Card className="bg-muted/50 border-primary/20 animate-pulse rounded-2xl">
  ...
  return (
    <Card className="bg-muted/50 border-primary/20 shadow-lg overflow-hidden rounded-2xl">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-primary-foreground/70 text-sm">Complete para ganhar XP!</p>
              </div>
            </div>
            <div className="flex items-center gap-2 bg-primary-foreground/15 px-3 py-1.5 rounded-full">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className={`font-medium ${isCompleted ? 'text-primary' : 'text-primary'}`}>
                            +{mission.xpReward} XP
                          </span>
                        </div>
                        <Progress
                          value={progressPercent}
                          className={`h-2 ${isCompleted ? '[&>div]:bg-accent' : '[&>div]:bg-primary'}`}
                        />
                      </div>
                    </div>
