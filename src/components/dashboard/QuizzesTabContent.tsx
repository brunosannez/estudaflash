    ...
    <div className={`${designColors.cards.secondary} text-center py-8 sm:py-16 px-4 sm:px-8`}>
      ...
      <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:gap-6 justify-center">
        ...
        <Button 
          variant="outline"
          onClick={onUploadNew}
          className={`border-2 border-green-300 text-foreground/80 font-bold ${designColors.responsive.buttonPadding} rounded-xl shadow-lg ${designColors.responsive.heroText} hover:bg-green-50 ${designColors.animations.buttonHover}`}
        >
          📤 Fazer Novo Upload
        </Button>
      </div>
