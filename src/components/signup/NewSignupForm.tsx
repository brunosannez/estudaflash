      ...
      return (
        <div className="space-y-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Selecione o plano que melhor se adapta aos seus estudos</p>
          </div>
          <PlanSelection
            ...
            <div className="flex justify-between mt-8">
              ...
              {isLastStep ? (
                <Button
                  ...
                  className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white min-w-[120px]"
                >
